#Esto es un programa que genera 1 combinación de 4 numeros de Bono-Loto que no han salido
# basandose en un archivo historico, tambien genera 1 combinación de 2 numeros que no han salido.
# Se llama combinacion 4-2
